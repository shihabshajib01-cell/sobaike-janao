    ...
    return (
      <button
        ...
        className={`w-full flex items-center justify-between p-2 md:p-2.5 rounded-[var(--radius-control)] text-left transition-all cursor-pointer border group min-h-[44px] focus:outline-none focus-visible:ring-2 focus-visible:ring-ui-focus ${
          isSelected
            ? 'bg-ui-accent-soft border-ui-accent/40 text-ui-content-primary ring-1 ring-ui-accent/30 font-medium shadow-[var(--elevation-2xs)]'
            : 'bg-ui-surface-subtle border-ui-stroke-subtle hover:border-ui-stroke-default text-ui-content-primary'
        }`}
      >
        <div className="flex items-center gap-2 md:gap-2.5 min-w-0">
          <span
            className={`w-5.5 h-5.5 md:w-6 md:h-6 rounded-[var(--radius-badge-sm)] flex items-center justify-center text-[var(--type-fixed-11)] md:text-[var(--type-fixed-12)] font-bold shrink-0 border ${
              isSelected
          ...
          <div className="min-w-0">
            <span className="text-[var(--type-fixed-13)] md:text-[var(--type-fixed-14)] font-bold text-ui-content-primary group-hover:text-ui-content-primary transition-colors truncate block">
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          <span className="text-[var(--type-fixed-13)] font-bold text-ui-content-primary tabular-nums">
            {countDisplay}
          </span>
    ...
    >
      ...
      <div className="flex items-start justify-between border-b border-ui-stroke-subtle pb-2.5 md:pb-3 gap-2">
        <div className="min-w-0 space-y-0.5">
          <div className="flex items-center gap-1.5">
            ...
            <h3 className="text-[var(--type-fixed-15)] md:text-[var(--type-fixed-16)] font-bold text-ui-content-primary tracking-tight truncate">
      ...
      <div className="bg-ui-surface-subtle border border-ui-stroke-subtle rounded-[var(--radius-control)] p-3 md:p-3.5 space-y-3 sm:space-y-0 sm:flex sm:items-start sm:justify-between sm:gap-3">
        <div className="shrink-0">
          <span className="text-[var(--type-fixed-11)] md:text-[var(--type-fixed-12)] font-medium text-ui-content-muted block">
            {language === 'bn' ? 'মোট প্রকাশিত প্রতিবেদন' : 'Total published reports'}
          </span>
          <span className="text-[var(--type-fixed-22)] md:text-[var(--type-fixed-26)] font-bold text-ui-content-primary tabular-nums leading-tight mt-0.5 block">
        ...
        {mostReportedTopicAnalysis.status !== 'empty' && (
          <div className="sm:text-right min-w-0 sm:max-w-[65%]">
            ...
            <div className="flex items-start sm:justify-end gap-1.5 mt-1 flex-wrap">
              ...
              <div className="text-[var(--type-fixed-13)] md:text-[var(--type-fixed-14)] font-bold text-ui-content-primary break-words whitespace-normal leading-snug">
                <span>{mostReportedTopicAnalysis.label}</span>
                {mostReportedTopicAnalysis.status === 'tie' && (
                  <span className="tabular-nums ml-1.5 font-normal text-ui-content-muted text-[var(--type-fixed-12)] whitespace-nowrap">
      ...
      <div className="space-y-1.5 md:space-y-2">
        <div className="flex items-center justify-between text-[var(--type-fixed-12)] md:text-[var(--type-fixed-13)] font-bold text-ui-content-secondary">
          <span>{language === 'bn' ? 'বিষয় অনুযায়ী প্রতিবেদন' : 'Reports by topic'}</span>
          <span className="text-[var(--type-fixed-11)] font-normal text-ui-content-muted">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-1.5 md:gap-2">
          {categories.map((cat) => (
            ...
            >
              ...
              <span className="font-bold text-ui-content-primary tabular-nums text-[var(--type-fixed-13)] md:text-[var(--type-fixed-14)] shrink-0 ml-2">
      ...
      <div className="space-y-2 pt-1 border-t border-ui-stroke-subtle">
        <div className="flex items-center justify-between text-[var(--type-fixed-12)] md:text-[var(--type-fixed-13)]">
          ...
          {rankedDistricts.length > 0 && (
            <span className="text-[var(--type-fixed-11)] text-ui-content-muted font-medium">
              {language === 'bn'
