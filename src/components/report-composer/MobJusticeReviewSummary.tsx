...
const ReviewValue: React.FC<{ label: string; value: React.ReactNode }> = ({ label, value }) => (
  <div className="space-y-1">
    <p className="type-helper font-[var(--font-weight-semibold)] text-ui-content-muted">{label}</p>
    <p className="type-h1 type-helper font-[var(--font-weight-medium)] text-ui-content-primary leading-relaxed">{value}</p>
  </div>
);
