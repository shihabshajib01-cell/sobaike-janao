        ...
        <div className="space-y-6">
          <div className="bg-ui-surface border border-ui-stroke-subtle rounded-[var(--radius-card)] p-6 md:p-8 space-y-6 shadow-[var(--elevation-2xs)]">
            ...
            <div className="p-5 bg-ui-surface-subtle border border-ui-stroke-subtle rounded-[var(--radius-control)] space-y-2">
              ...
              <p className="text-[var(--type-fixed-14)] leading-[var(--type-line-22)] text-ui-content-muted">
                {language === 'bn'
          ...
          <div className="bg-ui-surface border border-ui-stroke-subtle rounded-[var(--radius-card)] p-6 md:p-8 space-y-6 shadow-[var(--elevation-2xs)]">
            ...
            <div className="space-y-4">
              <div className="p-5 bg-ui-surface-subtle border border-ui-stroke-subtle rounded-[var(--radius-control)] space-y-2">
                ...
                <p className="text-[var(--type-fixed-15)] leading-[var(--type-line-24)] text-ui-content-secondary pl-11">
                  {language === 'bn'
      ...
      {activeTab === 'faq' && (
        <div className="bg-ui-surface border border-ui-stroke-subtle rounded-[var(--radius-card)] p-6 md:p-8 space-y-6 shadow-[var(--elevation-2xs)]">
          ...
          <div className="space-y-3">
            ...
            >
              <p className="text-ui-content-secondary text-[var(--type-fixed-15)] leading-[var(--type-line-24)]">
                {language === 'bn'
