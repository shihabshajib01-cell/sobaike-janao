      ...
      <div className="w-full text-left">
        ...
        <div className="relative">
          <select
            ...
            className={`w-full appearance-none min-h-[44px] bg-surface text-primary ui-border-default ui-radius-control ui-space-select transition-colors focus:outline-none focus:ring-2 focus:ring-[var(--ui-focus)] focus:border-[var(--ui-accent)] disabled:bg-surface-subtle disabled:text-muted disabled:cursor-not-allowed ${
              error
        ...
        {!error && helperText && (
          <p id={`${selectId}-helper`} className="mt-1.5 type-helper text-muted">
            {helperText}
          </p>
        )}
      </div>
