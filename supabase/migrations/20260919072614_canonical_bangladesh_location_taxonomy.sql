...
-- Compatibility helpers required by the bilingual report migrations that follow.
...
create or replace function public.build_public_location(
  p_formatted text,p_road text,p_area text,p_landmark text,p_upazila text,p_district text,p_lang text
)
returns text
language plpgsql
stable
