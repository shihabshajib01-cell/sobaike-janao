      ...
      <div className="w-full max-w-[640px] mx-auto py-10 md:py-16 text-center space-y-6">
        ...
        <div className="flex justify-center">
          <span
            ...
            className="inline-flex items-center gap-1.5 px-3.5 py-1 rounded-[var(--radius-pill)] type-compact font-[var(--font-weight-semibold)] bg-ui-surface-subtle border border-ui-stroke-subtle text-ui-content-secondary shadow-[var(--elevation-2xs)]"
          >
