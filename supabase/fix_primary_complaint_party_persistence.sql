...
--   2. Updates public.submit_public_complaint(jsonb, text, jsonb) to persist a
--      primary complaint_parties record whenever meaningful party information exists
--      (reportedSubject, roleOrDesignation, organization, phoneOrContact/publicProfileHandle,
--      identifyingDescription, address, or explicit known subjectType), avoiding data loss.
--   3. Strictly preserves 3-argument signature, reporter-device GPS handling,
--      idempotency, RLS, privacy, and evidence handling.
-- =============================================================================
...
-- Step 2: Update submit_public_complaint RPC with corrected Step 10 persistence logic
