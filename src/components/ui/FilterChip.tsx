...
export const FilterChip: React.FC<FilterChipProps> = ({
  ...
  return (
    ...
    >
      ...
      {count !== undefined && (
        <span
          className={`ml-0.5 text-[var(--type-fixed-11)] sm:text-[var(--type-fixed-12)] px-1.5 py-0.2 rounded-[var(--radius-pill)] font-[var(--font-weight-semibold)] leading-none ${
            selected
