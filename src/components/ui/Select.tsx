        ...
        <div className="relative">
          <select
            ...
            className={joinFormClasses(
              'w-full min-w-0 max-w-full appearance-none min-h-[44px] bg-role-surface text-role-on-surface ui-border-default ui-radius-control ui-space-select type-input transition-colors focus:outline-none focus:ring-2 disabled:bg-role-disabled-container disabled:text-role-on-disabled disabled:cursor-not-allowed',
