    ...
    >
      <div className="p-5 sm:p-6 flex flex-col gap-5 text-ui-content-primary">
        ...
        <div id="first-visit-notice-desc" className="text-sm text-ui-content-secondary space-y-3 leading-relaxed">
          ...
          <div className="p-3.5 rounded-xl bg-ui-surface-subtle border border-ui-stroke-subtle text-xs space-y-2">
            <div className="flex items-start gap-2.5">
              <span className="font-bold text-ui-brand-text shrink-0">১.</span>
              <span>
                {isBn
            ...
            <div className="flex items-start gap-2.5">
              <span className="font-bold text-ui-brand-text shrink-0">২.</span>
              <span>
                {isBn
            ...
            <div className="flex items-start gap-2.5">
              <span className="font-bold text-ui-brand-text shrink-0">৩.</span>
              <span>
                {isBn
        ...
        <div className="pt-1 border-t border-ui-stroke-subtle">
          <Checkbox
            ...
            label={
              <span className="text-sm font-medium text-ui-content-primary">
                {isBn
