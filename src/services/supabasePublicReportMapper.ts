...
export const mapSupabasePublicReportToItem = (
  ...
  return {
    ...
    viewCount: rpc.viewCount !== undefined && rpc.viewCount !== null ? Number(rpc.viewCount) : 0,
    shareCount: rpc.shareCount !== undefined && rpc.shareCount !== null ? Number(rpc.shareCount) : 0,
    evidenceSummaryBn: [],
    evidenceSummaryEn: [],
    status: 'published',
    statusBn: 'প্রকাশিত',
