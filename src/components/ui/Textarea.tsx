    ...
    return (
      <div className="w-full text-left">
        ...
        <textarea
          ...
          className={`w-full bg-surface text-primary placeholder:text-muted border ui-radius-control p-3.5 transition-colors focus:outline-none focus:ring-2 focus:ring-[var(--ui-focus)] focus:border-[var(--ui-accent)] disabled:bg-surface-subtle disabled:text-muted disabled:cursor-not-allowed ${
            error
