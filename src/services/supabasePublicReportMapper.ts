...
export const mapSupabasePublicReportToItem = (
  ...
  return {
    ...
    intimateWhatHappened: rpc.intimateWhatHappened || undefined,
    intimatePlatform: rpc.intimatePlatform || undefined,
    ...
    viewCount: Math.max(0, Number(rpc.viewCount) || 0),
    shareCount: Math.max(0, Number(rpc.shareCount) || 0),
    evidenceSummaryBn: [],
    evidenceSummaryEn: [],
    status: 'published',
    statusBn: 'প্রকাশিত',
