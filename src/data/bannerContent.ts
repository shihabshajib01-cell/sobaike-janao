...
export const CANONICAL_BANNER_CONTENT: Record<SectionKey, CategoryBannerContent> = {
  ...
  rickshaw: {
    section: 'rickshaw',
    titleBn: 'অবৈধ অটো-রিকশা চার্জিং স্টেশন',
    titleEn: 'Illegal Auto-rickshaw Charging Station',
    mobileDescriptionBn: 'আপনার এলাকায় কি কোনো অবৈধ বা ঝুঁকিপূর্ণ অটো-রিকশা চার্জিং স্টেশন রয়েছে?',
    mobileDescriptionEn: 'Is there an illegal or unsafe auto-rickshaw charging station nearby?',
    tabletDescriptionBn: 'অনিরাপদ অটো-রিকশা ব্যাটারি চার্জিং ও ঝুঁকিপূর্ণ বিদ্যুৎ সংযোগের তথ্য দিন।',
    tabletDescriptionEn: 'Report unsafe auto-rickshaw battery charging and risky electrical connections.',
    desktopDescriptionBn: 'অবৈধ বা অনিরাপদ অটো-রিকশা চার্জিং স্টেশন, খোলা তার বা ঝুঁকিপূর্ণ বিদ্যুৎ সংযোগের তথ্য জানান।',
    desktopDescriptionEn: 'Report illegal or unsafe auto-rickshaw charging stations, exposed wiring, or risky power connections.',
