    ...
    return (
      <div className="w-full text-left">
        ...
        <textarea
          ...
          className={`w-full bg-ui-surface text-ui-content-primary placeholder:text-muted ui-border-default ui-radius-control ui-space-textarea transition-colors focus:outline-none focus:ring-2 focus:ring-[var(--ui-focus)] disabled:bg-surface-subtle disabled:text-muted disabled:cursor-not-allowed ${
            error
