      ...
      >
        <div className="p-5 sm:p-6 md:p-8 space-y-4 sm:space-y-5 text-left">
          ...
          <div className="space-y-3 text-[13.5px] sm:text-[14px] leading-relaxed text-ui-content-secondary bg-ui-surface-subtle p-3.5 sm:p-4 rounded-2xl border border-ui-stroke-subtle max-h-[40vh] sm:max-h-[45vh] overflow-y-auto">
            ...
            <p>
              {language === 'bn'
                ? 'নিরাপত্তা ও অপব্যবহার রোধে প্রকাশিত প্রতিবেদনে অভিযুক্ত ব্যক্তি বা প্রতিষ্ঠানের আসল নাম দেখানো হবে না। সুরক্ষার স্বার্থে মডারেশন টিম তথ্য সম্পাদনা বা গোপন করতে পারে। নিরাপদভাবে প্রকাশ করা সম্ভব না হলে প্রতিবেদনটি প্রকাশ নাও হতে পারে।'
                : 'To prevent harm and misuse, published reports will not display the real name of an accused person or organization. Details may be redacted or edited for safety, and reports may not be published if they cannot be shared safely.'}
            </p>
          </div>
