...
export const IconButton: React.FC<IconButtonProps> = ({
  ...
  const sizeClasses: Record<IconButtonSize, string> = {
    sm: 'min-w-[44px] min-h-[44px] rounded-[var(--radius-badge-md)] p-2.5', // Touch friendly >= 44px
    md: 'w-11 h-11 min-w-[44px] min-h-[44px] rounded-[var(--radius-control)] p-2.5', // Touch friendly >= 44px
    lg: 'w-12 h-12 min-w-[48px] min-h-[48px] rounded-[var(--radius-control)] p-3',
  };
