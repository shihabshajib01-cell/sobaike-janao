...
export const ReportCard: React.FC<ReportCardProps> = ({ report, className = '' }) => {
  ...
  return (
    <article
      ...
      className={`group relative bg-ui-surface ui-border-default border-ui-stroke-subtle ui-radius-card p-3.5 sm:p-4 md:p-6 transition-colors duration-150 ui-elevation-card hover:bg-ui-surface-elevated cursor-pointer text-left space-y-2 sm:space-y-2.5 md:space-y-3 select-none ${className}`}
    >
      ...
      <h3 className="text-ui-content-primary transition-colors line-clamp-2 break-words">
        {title}
      </h3>
      ...
      {report.reportedSubject && (
        <div className="type-meta text-ui-content-secondary flex items-center gap-1.5 flex-wrap min-w-0">
          ...
          <p className="type-meta font-semibold text-ui-content-primary truncate max-w-full">
            {report.reportedSubject}
          </p>
        </div>
      )}
      ...
      {(report.subcategoryId === 'excess-electricity-bill' || report.recentBillAmount !== undefined) && (
        <div className="flex items-center gap-2 type-meta bg-ui-surface-subtle ui-border-default border-ui-stroke-subtle ui-radius-badge-md px-2.5 py-1 text-ui-content-secondary max-w-full flex-wrap">
          <p className="type-meta font-semibold text-ui-content-primary">
      ...
      <div className="type-meta flex items-center justify-between gap-2 pt-2 sm:pt-2.5 md:pt-3 border-t border-ui-stroke-subtle text-ui-content-muted">
        ...
        <div className="flex items-center gap-1 sm:gap-2 md:gap-3 shrink-0">
          <button
            ...
            className="type-action inline-flex items-center justify-center gap-1 sm:gap-1.5 text-ui-content-secondary transition-colors cursor-pointer py-1.5 px-2 min-h-[44px] min-w-[44px] ui-radius-badge-md hover:bg-ui-surface-hover focus:outline-none focus-visible:ring-2 focus-visible:ring-ui-focus active:scale-95"
          >
            {isCopied ? (
              <span className="inline-flex items-center gap-1" aria-live="polite">
                ...
                <span className="text-ui-success-text font-semibold">
          ...
          <Link
            ...
            className="type-action inline-flex items-center gap-1 sm:gap-1.5 font-semibold text-ui-content-primary hover:bg-ui-surface-hover transition-colors py-1.5 px-1 min-h-[44px] focus:outline-none focus-visible:ring-2 focus-visible:ring-ui-focus ui-radius-badge-md"
          >
