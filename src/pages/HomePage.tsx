        ...
        {!isLoading && fetchError && (
          <div role="alert" className="bg-ui-surface border border-ui-error-border rounded-[var(--radius-card)] p-6 text-center space-y-3">
            ...
            <button
              type="button"
              onClick={loadReports}
              className="btn-primary-action px-4 py-2 text-[var(--type-fixed-14)] font-[var(--font-weight-semibold)] rounded-[var(--radius-control)] min-h-[44px] focus:outline-none focus-visible:ring-2 focus-visible:ring-ui-focus cursor-pointer"
            >
