...
requireContains('Composer section changes move focus', composerHeader, 'sectionStatusRef.current?.focus');
requireContains('Composer section state is announced without a visual stepper', composerHeader, 'aria-live="polite"');
