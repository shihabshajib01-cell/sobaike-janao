  ...
  return (
    <PublicPageContainer id="issues-page-container" className="md:hidden">
      <section aria-labelledby="issues-page-title" className="space-y-1">
        <h1 id="issues-page-title" className="text-ui-content-primary">
      ...
      {hasCountError && (
        <button
          type="button"
          onClick={loadCounts}
          className="flex min-h-[44px] w-full items-center gap-2 ui-radius-control ui-border-default border-ui-warning-border bg-ui-warning-bg px-3 py-2.5 text-left type-meta font-medium text-ui-warning-text cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-ui-focus"
        >
        ...
        {cards.map(({ key, config }) => {
          ...
          return (
            <button
              ...
              className="min-h-[84px] ui-radius-card ui-border-default bg-ui-surface px-3.5 py-3 text-left ui-elevation-card transition-all hover:bg-ui-surface-hover active:scale-[0.99] cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-ui-focus"
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <p className="type-meta shrink-0 text-right font-medium text-ui-content-secondary">
                  {isLoading
                    ? language === 'bn'
                      ? 'গণনা হচ্ছে...'
                      : 'Counting...'
