  ...
  return (
    ...
    >
      <div className="space-y-0.5">
        <h1 className="type-h1 leading-[var(--type-line-ratio-130)] font-[var(--font-weight-bold)] text-ui-content-primary tracking-tight">
          {language === 'bn' ? 'প্রতিবেদন বিশ্লেষণ' : 'Report insights'}
        </h1>
        <p className="type-h4 leading-[var(--type-line-ratio-150)] text-ui-content-secondary">
          {language === 'bn'
      ...
      >
        <button
          ...
          className={`px-3.5 py-2 rounded-[var(--radius-badge-md)] type-compact font-[var(--font-weight-semibold)] flex items-center gap-2 transition-all cursor-pointer min-h-[44px] focus:outline-none focus-visible:ring-2 focus-visible:ring-ui-focus border ${
            viewMode === 'reports'
