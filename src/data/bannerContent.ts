...
export const CANONICAL_BANNER_CONTENT: Record<SectionKey, CategoryBannerContent> = {
  harassment: {
    ...
    mobileDescriptionBn: 'আপনি বা পরিচিত কেউ কি হয়রানি বা নির্যাতনের শিকার হয়েছেন?',
    mobileDescriptionEn: 'Have you or someone you know experienced harassment or abuse?',
    tabletDescriptionBn: 'আপনি বা পরিচিত কেউ কি হয়রানি বা নির্যাতনের শিকার হয়েছেন?',
    tabletDescriptionEn: 'Have you or someone you know experienced harassment or abuse?',
    desktopDescriptionBn: 'আপনি বা পরিচিত কেউ কি হয়রানি বা নির্যাতনের শিকার হয়েছেন?',
  ...
  extortion: {
    ...
    mobileDescriptionBn: 'ঘুষ চাওয়া বা অবৈধভাবে টাকা দাবি করার কোনো ঘটনা দেখেছেন?',
    mobileDescriptionEn: 'Seen someone demand a bribe or illegally ask for money?',
    tabletDescriptionBn: 'ঘুষ চাওয়া বা অবৈধভাবে টাকা দাবি করার কোনো ঘটনা দেখেছেন?',
    tabletDescriptionEn: 'Seen someone demand a bribe or illegally ask for money?',
    desktopDescriptionBn: 'ঘুষ চাওয়া বা অবৈধভাবে টাকা দাবি করার কোনো ঘটনা দেখেছেন?',
  ...
  road_transport: {
    ...
    mobileDescriptionBn: 'ক্ষতিগ্রস্ত রাস্তা, দুর্ঘটনার ঝুঁকি বা যানজটের সমস্যা দেখেছেন?',
    mobileDescriptionEn: 'Seen damaged roads, traffic hazards, or serious congestion nearby?',
    tabletDescriptionBn: 'ক্ষতিগ্রস্ত রাস্তা, দুর্ঘটনার ঝুঁকি বা যানজটের সমস্যা দেখেছেন?',
    tabletDescriptionEn: 'Seen damaged roads, traffic hazards, or serious congestion nearby?',
    desktopDescriptionBn: 'ক্ষতিগ্রস্ত রাস্তা, দুর্ঘটনার ঝুঁকি বা যানজটের সমস্যা দেখেছেন?',
  ...
  load_shedding: {
    ...
    mobileDescriptionBn: 'বিদ্যুৎ, গ্যাস, পানি বা অন্যান্য ইউটিলিটি সমস্যায় ভুগছেন?',
    mobileDescriptionEn: 'Facing problems with electricity, gas, water, or other utilities?',
    tabletDescriptionBn: 'বিদ্যুৎ, গ্যাস, পানি বা অন্যান্য ইউটিলিটি সমস্যায় ভুগছেন?',
    tabletDescriptionEn: 'Facing problems with electricity, gas, water, or other utilities?',
    desktopDescriptionBn: 'বিদ্যুৎ, গ্যাস, পানি বা অন্যান্য ইউটিলিটি সমস্যায় ভুগছেন?',
  ...
  illegal_occupation: {
    ...
    mobileDescriptionBn: 'রাস্তা, ফুটপাত বা সরকারি জায়গা অবৈধভাবে দখল করা হয়েছে?',
    mobileDescriptionEn: 'Seen roads, footpaths, or public spaces being occupied illegally?',
    tabletDescriptionBn: 'রাস্তা, ফুটপাত বা সরকারি জায়গা অবৈধভাবে দখল করা হয়েছে?',
    tabletDescriptionEn: 'Seen roads, footpaths, or public spaces being occupied illegally?',
    desktopDescriptionBn: 'রাস্তা, ফুটপাত বা সরকারি জায়গা অবৈধভাবে দখল করা হয়েছে?',
  ...
  rickshaw: {
    ...
    mobileDescriptionBn: 'আপনার এলাকায় অবৈধ বা ঝুঁকিপূর্ণ অটো চার্জিং স্টেশন দেখেছেন?',
    mobileDescriptionEn: 'Seen an illegal or unsafe auto charging station in your area?',
    tabletDescriptionBn: 'আপনার এলাকায় অবৈধ বা ঝুঁকিপূর্ণ অটো চার্জিং স্টেশন দেখেছেন?',
    tabletDescriptionEn: 'Seen an illegal or unsafe auto charging station in your area?',
    desktopDescriptionBn: 'আপনার এলাকায় অবৈধ বা ঝুঁকিপূর্ণ অটো চার্জিং স্টেশন দেখেছেন?',
